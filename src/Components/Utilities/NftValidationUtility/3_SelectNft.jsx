          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-1">
            {utility?.nfts?.nfts?.map((nft) => (
              <div
                ...
                className={` border border-gray-300 bg-white px-6 py-5 shadow-sm focus-within:ring-2 focus-within:ring-whal3s-500 focus-within:ring-offset-2 hover:border-gray-400 ${
                  utility.tokenId === nft.attributes.id.tokenId
                    ? "ring-2 ring-whal3s-500 ring-offset-2"
                    : ""
                }`}
              >
